        ...
        <div className='footer-container'>
            ...
            <section className="social-media">
                <div className="social-media-wrap">
                    ...
                    <small className="website-rigth">TRVL @ 2020</small>
                    <div className='social-icons'>
                        <Link class='social-icon-link facebook' to='/' target='_blank' aria-label='Facebook'> <i className='fab fa-facebook-f'/></Link>
                        <Link class='social-icon-link instagram' to='/' target='_blank' aria-label='Instagram'> <i className='fab fa-instagram'/></Link>
